...
set flags=-MDd -nologo -fp:fast -Gm- -GR- -EHa- -Oi -W4 -wd4100 -wd4201 -wd4505 -FC -Od -Zi -std:c++17 -arch:AVX -FeVoxel.exe
set defines=-D_DEBUG=1 -D_CRT_SECURE_NO_WARNINGS=1 -D_HAS_EXCEPTIONS=0
set libs=-incremental:no -opt:ref winmm.lib gdi32.lib user32.lib Shell32.lib opengl32.lib glew32sd.lib glfw3-d.lib noise-d.lib
set link=/LIBPATH:W:\Common\Lib /SUBSYSTEM:WINDOWS /ENTRY:"mainCRTStartup"
