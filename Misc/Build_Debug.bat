...
set libs=-incremental:no -opt:ref winmm.lib gdi32.lib user32.lib Shell32.lib opengl32.lib glew32s.lib glfw3.lib noise-d.lib LinearMath.lib BulletCollision.lib
